...
(function() {
  ...
  (refreshSize = function() {
    ...
    _ref1 = ['rain', 'humidity', 'cloudcover', 'phrase'];
    _results = [];
  ...
  refreshFore = function() {
    return $.getJSON('/forecast', function(data) {
      var cloudcover, high, humidity, iconURL, phrase, rain, wind;
      iconURL = data.iconURL, high = data.high, phrase = data.phrase, rain = data.rain, wind = data.wind, humidity = data.humidity, cloudcover = data.cloudcover;
        ...
        return div('#forecast', {
          ...
          div('#row3', {
            ...
            div({
              ...
              return div('#cloudcover', (cloudcover ? 'Clouds ' + cloudcover + '%' : ''));
            });
            div({
              style: 'float:right; margin-right:10%; width:32%; text-align:right'
            }, function() {
              return div('#rain', (rain != null ? 'Rain ' + rain + '"' : ''));
            });
            return div({
              style: 'clear:both'
            });
